...
- **Hosted CI:** Public `main` at `f5b00155df3aa659df478f5409be231a3d883869` passed [GitHub Actions run 35705366882](https://github.com/raydeStar/framewright/actions/runs/35705366882): build/API, container runtime, and all browser acceptance checks were green. It includes the M17 baseline, portable recovery extension, reusable-asset discovery, and Director-view synchronization fix.
