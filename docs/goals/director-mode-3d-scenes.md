...
- **Hosted CI:** Public `main` at `774cf6691a1323a2d89b694aa01b8e7aecd6860d` passed [GitHub Actions run 35700469040](https://github.com/raydeStar/framewright/actions/runs/35700469040): build/API, container runtime, and all browser acceptance checks were green. It includes the M17 baseline and portable recovery extension. The reusable-asset discovery increment in the current checkout is newer and must receive its own exact-head hosted result after push.
