...
- **Assets:** one searchable media pool for images, music/audio, video takes, and authority canon; manual collections, smart views, editable metadata, non-destructive archive, and explicit shot placements; image creation enters the existing sketch/approval route and music enters the existing separate audio workflow.
