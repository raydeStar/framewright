...
Prepared 2026-09-21 and refreshed through the M17 recovery increment on 2026-09-22. The exact-frame scene-render baseline `bee78f84855354e3ce7b126055d6088cb1da3605` is hosted-green; the current checkout extends its portable recovery path as described below. This is a continuation brief, not an instruction to start generation or a claim of release readiness.
...
The M17 scene-render baseline passed [hosted run 35695942853](https://github.com/raydeStar/framewright/actions/runs/35695942853): build/API, container runtime, and browser acceptance were all green. The portable recovery extension is newer and requires its own exact-head hosted result after push.
