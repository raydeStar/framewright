...
Prepared 2026-09-21 and refreshed after the public-main MVP increments. The last hosted-green recovery baseline before this follow-on checkpoint is `c2354731d5b52f062be9de1dda0202114a4c0a65`; the current checkout adds the isolated-workspace scene-graph recovery proof described below. This is a continuation brief, not an instruction to start generation or a claim of release readiness.
...
The last hosted-green recovery baseline before this follow-on checkpoint passed [hosted run 35688271982](https://github.com/raydeStar/framewright/actions/runs/35688271982): build/API, container runtime, and browser acceptance were all green.
