...
Prepared 2026-09-21 and refreshed through the M17 contract increment on 2026-09-22. The last hosted-green baseline before this checkpoint is `d6e47aff247c77371f7bc946749f665609cd9433`; the current checkout adds the exact-frame scene-render path described below. This is a continuation brief, not an instruction to start generation or a claim of release readiness.
...
The last hosted-green baseline before this checkpoint passed [hosted run 35690353988](https://github.com/raydeStar/framewright/actions/runs/35690353988): build/API, container runtime, and browser acceptance were all green.
