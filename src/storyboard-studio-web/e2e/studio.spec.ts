...
test('connection surface reports safe workstation boundaries', async ({ page }) => {
  ...
  await expect(page.getByRole('button', { name: /Streaming UHD/ })).toBeVisible()
  await expect(page.getByRole('button', { name: /Streaming HD/ })).toBeVisible()
  ...
  await page.getByRole('button', { name: /Streaming HD/ }).click()
